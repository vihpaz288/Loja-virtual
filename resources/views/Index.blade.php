        ...
        <div class="offcanvas offcanvas-start" tabindex="-1" id="sidebar">
            ...
            <div class="offcanvas-body">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{route ('dados', Auth::user()->id) }}">Dados do usuario</a>
                    </li>
                    @if (auth()->check())
                            ...
                            <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
                                <div class="card text-center bg-light">
                                    ...
                                    <a href="{{ route('detalhes.produto', $produto->id) }}">
                                        <img src="{{ asset('storage/' . $produto->image[0]->image) }}" class="card-img-top"
                                        ...
                                        @if (auth()->check())
                                            @if (auth()->user()->permissaoID == 1)
                                                <form action="{{ route('produto.destroy', ['id' => $produto->id]) }}"
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-danger mt-2 d-block">Deletar Produto</button>
                                                </form>
                                            @else
                                                <button type="button" class="btn btn-danger mt-2 d-block"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <input type="hidden" name="valorTotal" value="{{$produto->valor}}">
                                                        <input type="hidden" name="foto" value="{{ asset('storage/' . $produto->foto1) }}">
