    ...
    <div class="d-flex flex-column wrapper">
        ...
        <main class="flex-fill">
            <div class="container">
                @if (isset($carrinho))
                <?php $total = 0?>
                        @foreach ($carrinho->produtos as $item1)
                                ...
                                <li class="list-group-item py-3">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-4 col-md-3 col-lg-2">
                                            <a href="">
                                                <img src="{{ asset('storage/' . $item1->produtos->image[0]->image) }}"
                                        ...
                                        <div class="col-8 col-md-9 col-lg-7 col-xl-8 text-left align-self-center">
                                            <h4>
                                                <b><a href=""
                                                        class="text-decoration-none text-danger">{{ $item1->produtos->nome }}</a></b>
                                            </h4>
                                            <h5>
                                                {{ $item1->produtos->descrição }}
                                            </h5>
                                        </div>
                                        <div
