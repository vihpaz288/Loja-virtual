                ...
                <table class="table">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th class="text-danger" scope="col">Estado</th>
                            <th class="text-danger" scope="col">CEP</th>
                            <th class="text-danger" scope="col">Cidade</th>
                            <th class="text-danger" scope="col">Rua</th>
                            <th class="text-danger" scope="col">numero</th>
                            <th class="text-danger" scope="col">complemento</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td id="valor_nome{{$endereco->id}}">{{$endereco->nome}}</td>
                            ...
                            <td id="valor_numero{{$endereco->id}}">{{$endereco->numero}}</td>
                            <td id="valor_complemento{{$endereco->id}}">{{$endereco->complemento}}</td>
                            <td> <button type='button' id='botao_editar{{ $endereco->id }}' class="btn btn-danger btn-block mb-4"
                                onclick='editar_registro({{ $endereco->id }})'>EDITAR</button>
                            <button type='button' id='botao_salvar{{ $endereco->id }}'class="btn btn-danger btn-block mb-4"
                                onclick='salvar_registro({{ $endereco->id }})'
                                style="display: none;">SALVAR</button>
                            </td>
                            <td>
                                <button type="submit" class="btn btn-danger btn-block mb-4" onclick="deletarEndereco({{$endereco->id}})">
                                    Deletar
                                </button>
                            </td>
            </tr>
